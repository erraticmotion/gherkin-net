// <copyright file="LexerScenariosBehaviour.cs" company="Erratic Motion Ltd">
...
namespace ErraticMotion.Test.Tools.Gherkin
{
    ...
    [TestFixture]
    public class LexerScenariosBehaviour : GivenWhenThen<IGherkinFeature>
    {
        /// <summary>
        ...
        [Test]
        public void ScenarioTwoTestCaseShouldBe()
        {
            var scenario = Sut.Scenarios[1];
            var then = scenario.Steps[GherkinStep.Then];
            then.Should().NotBeNull();
            then.TestCase.Parameters.Count().Should().Be(1);
        }
    }
}